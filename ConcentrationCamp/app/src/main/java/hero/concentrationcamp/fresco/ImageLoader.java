package hero.concentrationcamp.fresco;
...
import hero.concentrationcamp.fresco.listener.DownloadImageResult;
import hero.concentrationcamp.fresco.listener.LoadImageResult;
import hero.concentrationcamp.fresco.utils.StreamTool;
...
//                BitmapBlurHelper.blur(bitmap, 35);
            ...
            public void onNewResultImpl(DataSource<CloseableReference<PooledByteBuffer>> dataSource) {
                ...
                if (imageReference != null) {
                    ...
                    try {
                        ...
                        LogUtils.i("ImageLoader", "photoPath = " + photoPath);
     ...
     */
    public static void loadImageToReturnPath(final Context context, final String url, final LoadImageResult loadImageResult) {
        if (TextUtils.isEmpty(url)) {
            return;
        }
